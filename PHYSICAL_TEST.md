...
1. Print the needed pages at **100% / actual size**, with fitting disabled.
2. Measure the 100 mm calibration line on **each** page before cutting.
   If it does not measure 100 mm, correct the print settings before assessing fit.
...
| Calibration length on each printed page | Pending |
